...
import numpy as np
import joblib
from src.datascience_project_1.entity.config_entity import ModelEvaluationConfig
...
class ModelEvaluation:
    ...
    def log_into_mlflow(self):
        ...
        exp = mlflow.get_experiment_by_name("ModelEvaluation")
        print("here is the exp name",exp)
        if exp is None:
            mlflow.create_experiment("ModelEvaluation")
